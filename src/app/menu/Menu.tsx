  ...
  return (
    <section className="bg-menubg mt-8 flex w-full max-w-[1300px] flex-row">
                  ...
                  <Button
                    ...
                    className={cn(
                      ...
                      activeCategory === category._id
                        ? "bg-menuprimary hover:bg-buttonhover hover:text-menuprimary text-[#fff]"
                        : "border-menuprimary text-menuprimary hover:bg-menuprimary border-[1px] bg-transparent hover:text-[#fff]",
            ...
            {organizedMenu.map((category) => {
              return category.items.length > 0 ? (
                ...
                >
                  <h2
                    className={cn(
                      "text-menuprimary pb-4 text-2xl font-bold",
      ...
      <div className="hidden w-2/6 flex-col md:flex">
        <div className="bg-itembackground sticky top-0 z-10 h-fit overflow-y-visible px-4 py-2">
          <div className="scrollbar-none relative flex h-[85vh] flex-col gap-6 overflow-x-auto pb-2">
            ...
            {/* Footer */}
            <div className="bg-itembackground absolute bottom-0 left-0 z-30 flex w-full items-center justify-between">
